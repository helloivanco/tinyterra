...
export default function Example({ open, setOpen, token, value }) {
                ...
                <div className='mt-3 text-center sm:mt-5'>
                  ...
                  <div className='mt-2'>
                    <p className='text-sm text-gray-500'>
                      Based on an exchange rate of XYZ with{' '}
                      <span className='underline'>0.5% slippage</span>
                    </p>
                  </div>
                </div>
              </div>
